                    ...
                    <div class="card h-100 shadow-lg rounded-4 booking-card"
                        ...
                        <div class="card-body p-4">
                            ...
                            <div class="d-flex justify-content-between align-items-center mb-2">
                                <h5 class="mb-0 fw-bold"><?php echo e($booking->room->room_type); ?> Bed Room (<?php echo e($booking->room->room_number); ?>)</h5>
                                <span class="status-badge 
                                    <?php echo e(strtolower($booking->customer_status)); ?>">
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH E:\php internship\Laravel final project\hotel_management_system\resources\views\user\dashboard\my_bookings.blade.php ENDPATH**/ ?>